...
class ContactService {
     ...
     * Reuses connection across multiple calls.
     * 
    ...
    private static function getPdo(): PDO {
        if (self::$pdo === null) {
            try {
                ...
                error_log("ContactService PDO error: " . $e->getMessage());
                throw new Exception("Database connection failed in ContactService: " . $e->getMessage());
            }
        }
        return self::$pdo;
    }
